...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var tl = [
    ...
    "Bot না জানু,বলো 😌",
    "তোমার কি চোখে পড়ে না আমি ব্যাস্ত আছি😒",
    "আহ শুনাগো আমার 🌚😇",
    "আসসালামু আলাইকুম বলেন আপনার জন্য কি করতে পারি..!🥰",
    "আমাকে এতো না ডেকে বস খাইরুল কে একটা গফ দে 🙄",
    "আমাকে এতো না ডাকছো কেন ভলোবাসো নাকি🤭🙈",
    ...
    "𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊 𝐈𝐃 𝐋𝐈𝐍𝐊 🌻:- https://www.facebook.com/profile.php?id=100028810382467",
    ...
    "Bot না , জানু বল জানু 😘 ",
    "বার বার Disturb করছো কেনো😾,আমার বস খাইরুলের এর সাথে ব্যাস্ত আসি😋",
    ...
    "Bot না জানু,বল 😌",
    "বলো জানু 🌚",
    "তোর কি চোখে পড়ে না আমি বস খাইরুল এর সাথে ব্যাস্ত আসি😒",
  ...
  if (text === "...") {
    return api.sendMessage("তোমাকে কি কুকুর কামড় দিছে🤣", threadID);
  }
  ...
  if (text === "tor boss ke" || text === "admin ke ") {
    return api.sendMessage(
      "My Creator:Khairol ❤️ হাই আমি মেসেঞ্জার ROBOT  আামার বস খাইরুল আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন",
      threadID
    );
  }
