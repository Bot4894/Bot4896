...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  // টাইম ফরম্যাট ফিক্স: MM (মাস) নয়, mm (মিনিট)
  ...
  var tl = [
    ...
    "এতো ডাকছো কেনো গো I love you janu🥰",
    "আরে Bolo আমার জান ,কেমন আছো?😚",
    "Bot বলে অসম্মান করছো,😰😿",
    "Hop beda😾,Boss বল boss😼",
    "চুপ থাকো ,নই তো তোমার দাত ভেঙে দিবো😒",
    "Bot না , জানু বল জানু 😘",
    "তোমার কথা তোমার বাড়ির কেউ শুনে না ,তো আমি কেনো শুনবো গো ?🤔",
    "আমাকে ডেকো না,আমি ব্যস্ত আছি",
    "কি হলো , মিস্টেক করিচ্ছো নাকি🤣",
    "বলো কি বলবা, সবার সামনে বলবা নাকি?🤭🤏",
    "কালকে একটু আমার বস খাইরুলের সাথে দেখা কইরো আমার বস তোমাকে ডাকছে😃",
    "হা বলো, শুনছি আমি 😏",
    "আর কত বার ডাকবো ,শুনছি তো",
    "হুম বলো কি বলবে😒",
    "বলো কি করতে পারি তোমার জন্য",
    "আমি তো অন্ধ কিছু দেখি না🐸",
    "Bot না জানু,বলো 😌",
    "তোমার কি চোখে পড়ে না আমি ব্যস্ত আছি😒",
    "আহ শুনাগো আমার 🌚😇",
    "আসসালামু আলাইকুম বলেন আপনার জন্য কি করতে পারি..!🥰",
    "আমাকে এতো না ডেকে বস খাইরুল কে একটা গফ দে 🙄",
    "আমাকে এতো না ডাকছো কেন ভালোবাসো নাকি🤭🙈",
    "🌻🌺💚-আসসালামু আলাইকুম ওয়া রাহমাতুল্লাহ-💚🌺",
    "আমাকে না ডেকে আমার বস খাইরুল কে একটা জি এফ দাও-😽🫶🌺",
    ...
    "-অনুমতি দিলাম-𝙋𝙧𝙤𝙥𝙤𝙨𝙚 করো বস খাইরুল কে-🐸",
    ...
    "-আজ একটা বিন নেই বলে ফেসবুকের নাগিন-🤧-গুলোরে আমার বস খাইরুল ধরতে পারছে না-🐸🥲",
    "-চুমু থাকতে তোরা বিড়ি খাস কেন বুঝা আমারে-😑😒🐸⚒️",
    "—যে ছেড়ে গেছে-😔-তাকে ভুলে যাও-🙂-আমার বস খাইরুল এর সাথে প্রেম করে তাকে দেখিয়ে দাও-🙈🐸🤗",
    "—হাজারো লুচ্চা লুচ্চির ভিরে-🙊আমার বস খাইরুল এক নিস্পাপ ভালো মানুষ-🥱🤗🙆‍♂️",
    ...
    "-𝗜 𝗟𝗢𝗩𝗢 𝗬𝗢𝗨-😽-আহারে ভাবছো তোমারে প্রপোজ করছি-🥴-থাপ্পর দিয়া কিডনী লক করে দিব-😒-ভুল পড়া বের করে দিবো-🤭",
    "-আমি একটা দুধের শিশু-😇",
    "-কতদিন হয়ে গেলো বিছনায় মুতি না-😿-মিস ইউ নেংটা কাল-🥺🤧",
    "-ইস কেউ যদি বলতো-🙂-আমার শুধু তোমাকেই লাগবে-💜🌸",
    "-ওই বেডি তোমার বাসায় না আমার বস খাইরুল মেয়ে দেখতে গেছিলো-🙃-নাস্তা আনারস আর দুধ দিছো-🙄🤦‍♂️-বইন কইলেই তো হয় বয়ফ্রেন্ড আছে-🥺🤦‍♂-আমার বস খাইরুল কে জানে মারার কি দরকার-🙄🤧",
    ...
    "-দেশের সব কিছুই চুরি হচ্ছে-🙄-শুধু আমার বস খাইরুল এর মনটা ছাড়া-🥴😑😏",
    ...
    "এতো কাছেও এসো না,প্রেম এ পরে যাবো তো 🙈",
    "Bolo Babu, তুমি কি আমাকে ভালোবাসো? 🙈",
    "হা বলো😒,কি করতে পারি😐😑?",
    "মেয়ে হলে বস খাইরুলের সাথে প্রেম করো🙈??",
    "আরে Bolo আমার জান ,কেমন আসো?😚",
    "Bot বলে অসম্মান করিচ্ছো,😰😿",
    "Bot না , জানু বল জানু 😘",
    "বার বার Disturb করছো কেনো😾,আমার বস খাইরুলের এর সাথে ব্যস্ত আছি😋",
    "আরে আমি মজা করার mood এ নাই😒",
    "দূরে যাও, তোমার কোনো কাজ নাই, শুধু bot bot করো  😉😋🤣",
    "তোমার কথা তোমার বাড়ি কেউ শুনে না ,তো আমি কেনো শুনবো ?🤔😂",
    "আমাকে ডেকো না,আমি ব্যস্ত আছি",
    "কি হলো ,মিস টিস করছো নাকি🫢",
    "বলো কি বলবা, সবার সামনে বলবা নাকি?🤭🤏",
    ...
    "Bot না জানু,বল 😌",
    "বলো জানু 🌚",
    "তোর কি চোখে পড়ে না আমি বস খাইরুল এর সাথে ব্যস্ত আছি😒",
    "༊━━🦋নামাজি মানুষেরা সব থেকে বেশি সুন্দর হয়..!!😇🥀 🦋 কারণ.!! -অজুর পানির মত শ্রেষ্ঠ মেকআপ দুনিয়াতে নেই༊━ღ━༎🥰🥀 🥰",
    ...
    "- দুনিয়ার সবাই প্রেম করে.!🤧 -আর মানুষ আমার বস খাইরুল কে সন্দেহ করে.!🐸",
  ...
  if (event.body) {
    ...
    if (text == "miss you") {
      return api.sendMessage("<আমি ও😁🤖👅/👅-✘  🎀 🍒:))", threadID);
    }

    if (text == "😘" || text == "😽") {
      return api.sendMessage("কিস দিও না তোমার মুখে দূর গন্ধ কয়দিন ধরে দাঁত ব্রাশ করো নাই🤬", threadID);
    }

    if (text == "👍" || text == "👍🏼") {
      return api.sendMessage("এত লাইক দাও কেনো🤔.!🤣👍", threadID);
    }

    if (text == "sim" || text == "simsimi") {
    ...
    if (text == "tumi kado🥺" || text == "pain") {
      return api.sendMessage("~ তোমার কি হয়েছে🥺?? 🤖", threadID);
    }
    ...
    if (text == "owner" || text == "ceo") {
      return api.sendMessage(
        "‎[𝐎𝐖𝐍𝐄𝐑:☞ Khairol ッ ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 Khairol.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://www.facebook.com/profile.php?id=100028810382467\nতার সাথে যোগা যোগ করবেন WhatsApp :- +880140098***",
        threadID
      );
    }

    if (text == "tor boss ke" || text == "admin ke") {
      return api.sendMessage(
        "My Creator:Khairol ❤️ হাই আমি মেসেঞ্জার ROBOT  আমার বস খাইরুল আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন",
        threadID
      );
    }

    if (text == "admin" || text == "boter admin") {
      return api.sendMessage("He is Khairol ッ❤️ তাকে সবাই খাইরুল নামে চিনে🤙", threadID);
    }

    if (text == "bhabi" || text == "vabi") {
    ...
    if (
      ...
      return api.sendMessage("তুমি পাগল", threadID);
    }
  }
};
